...
IMG_OUT = ROOT / "derivatives" / "T1_images_registered_safe"
MASK_OUT = ROOT / "derivatives" / "T1_lesion_masks_registered_safe"

SUBJECTS = [f"sub-{i:03d}" for i in range(1, 133)]
...
print("="*78)
print("OpenSwissHCC SAFE REGISTRATION — FULL COHORT")
print("="*78)
...
print("\n" + "="*78)
print("ALL 132 SUBJECTS COMPLETED SUCCESSFULLY")
print("="*78)
